...
lineaccesstoken = 'RXN6JfP1wLQGc/oIQeGHS8tLN5DQRVkvyaTLI0mcHoyTOnBSW+vvA9/5xTa0gk9GmRTaeXTTxnxi5rREDCZ3UdEtJARPHQG5sHIOifC32DUK4k8lChAVVJRS1sMXQcyeJhg6nTG3lDxccvlGETn2UQdB04t89/1O/w1cDnyilFU=' 
...
def event_handle(event):
    ...
    if msgType == "text":
        ...
        if (msg == "สวัสดี") :
            ...
            line_bot_api.reply_message(rtoken, replyObj)
        elif (msg == "อร่อยมั้ยคะ") :
            replyObj = TextSendMessage(text="ก็อร่อยนะแต่ไม่เท่าเธอ")
            line_bot_api.reply_message(rtoken, replyObj)
        elif (msg == "เมื่อไหร่จะเลิกจีบคะ") :
            replyObj = TextSendMessage(text="สักวันค่ะแต่ไม่ใช่วันนี้")
            line_bot_api.reply_message(rtoken, replyObj)
        else : 
            headers = request.headers
            json_headers = ({k:v for k, v in headers.items()})
            json_headers.update({'Host':'bots.dialogflow.com'})
            url = "https://dialogflow.cloud.google.com/v1/integrations/line/webhook/e95b0302-16e1-4f4d-bdc4-0a1ae17e14f0"
